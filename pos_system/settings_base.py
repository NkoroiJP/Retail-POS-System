"""
Base settings for pos_system project.
...
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'admin@pos-system.com')
...
COMMISSION_RATE = 5.00  # Default commission rate percentage
VAT_RATE = 16.00  # VAT percentage
